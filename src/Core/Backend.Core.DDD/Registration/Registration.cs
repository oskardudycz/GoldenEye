...
namespace GoldenEye.Backend.Core.DDD.Registration
{
    ...
    {
        public static void UseCQRS(IServiceCollection services)
        {
        ...
        public static void RegisterCommandHandler<TCommand, TCommandHandler>(IServiceCollection services)
        ...
        public static void RegisterAsyncCommandHandler<TCommand, TCommandHandler>(IServiceCollection services)
            where TCommand : ICommand
        ...
        public static void RegisterQueryHandler<TQuery, TResponse, TQueryHandler>(IServiceCollection services)
        ...
        public static void RegisterAsyncQueryHandler<TQuery, TResponse, TQueryHandler>(IServiceCollection services)
            where TQuery : IQuery<TResponse>
        ...
        public static void RegisterEventHandler<TEvent, TEventHandler>(IServiceCollection services)
            where TEvent : IEvent
        ...
        public static void RegisterAsyncEventHandler<TEvent, TEventHandler>(IServiceCollection services)
            where TEvent : IEvent
