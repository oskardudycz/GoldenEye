...
* Updated `Backend.Core.EntityFramework` to `7.1.0` **[MINOR]**
* Updated `IdentityServer4` to `2.5.0` **[MINOR]**
* Updated `IdentityServer4.AspNetIdentity` to `2.5.0` **[MINOR]**
* Updated `IdentityServer4.EntityFramework` to `2.5.0` **[MINOR]**
...
* Updated `IdentityServer4.AspNetIdentity` to `2.3.0` **[MINOR]**
* Updated `IdentityServer4.EntityFramework` to `2.3.2` **[MINOR]**
* Updated `Microsoft.AspNetCore.Identity.EntityFrameworkCore` to `2.2.0` **[MINOR]**
...
# v5.1.0 (21.05.2019) [Pull Request](https://github.com/oskardudycz/GoldenEye/pull/59)
