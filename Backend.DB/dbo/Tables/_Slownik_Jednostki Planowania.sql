CREATE TABLE [dbo].[_Slownik_Jednostki Planowania] (
    ...
    CONSTRAINT [PK2_Slownik_Jednostki Planowania] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Slownik_Jednostki Planowania_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Slownik_Jednostki Planowania] ([Id]),
    CONSTRAINT [FK_Slownik_Jednostki Planowania_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Slownik_Jednostki Planowania] ([Id]),
    CONSTRAINT [FK_Slownik_Jednostki Planowania_TypId] FOREIGN KEY ([TypId]) REFERENCES [dbo].[Cecha_Typy] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Slownik_Jednostki Planowania]
    ON [dbo].[_Slownik_Jednostki Planowania]([Id] ASC);


GO

				CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Jednostki Planowania_UPDATE]
				   ON [dbo].[_Slownik_Jednostki Planowania] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Slownik_Jednostki Planowania]
							...
							UPDATE [dbo].[_Slownik_Jednostki Planowania]
				...
				END
GO
CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Jednostki Planowania_INSERT]
				   ON  [dbo].[_Slownik_Jednostki Planowania] 
				   AFTER INSERT
				AS 
				BEGIN
					...
					BEGIN
						IF EXISTS(
							...
							FROM inserted AS S1
							  JOIN [dbo].[_Slownik_Jednostki Planowania]  AS S2
						...
						BEGIN						
							...
							UPDATE [dbo].[_Slownik_Jednostki Planowania] SET 
				...
				END
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Slownik_Jednostki Planowania_INSERT]
    ON [dbo].[_Slownik_Jednostki Planowania];
