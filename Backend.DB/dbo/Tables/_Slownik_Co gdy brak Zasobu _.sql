CREATE TABLE [dbo].[_Slownik_Co gdy brak Zasobu ?] (
    ...
    CONSTRAINT [PK2_Slownik_Co gdy brak Zasobu ?] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Slownik_Co gdy brak Zasobu ?_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Slownik_Co gdy brak Zasobu ?] ([Id]),
    CONSTRAINT [FK_Slownik_Co gdy brak Zasobu ?_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Slownik_Co gdy brak Zasobu ?] ([Id]),
    CONSTRAINT [FK_Slownik_Co gdy brak Zasobu ?_TypId] FOREIGN KEY ([TypId]) REFERENCES [dbo].[Cecha_Typy] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Slownik_Co gdy brak Zasobu ?]
    ON [dbo].[_Slownik_Co gdy brak Zasobu ?]([Id] ASC);


GO
CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Co gdy brak Zasobu ?_INSERT]
				   ON  [dbo].[_Slownik_Co gdy brak Zasobu ?] 
				   AFTER INSERT
				AS 
				BEGIN
					...
					BEGIN
						IF EXISTS(
							...
							FROM inserted AS S1
							  JOIN [dbo].[_Slownik_Co gdy brak Zasobu ?]  AS S2
						...
						BEGIN						
							...
							UPDATE [dbo].[_Slownik_Co gdy brak Zasobu ?] SET 
				...
				END
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Slownik_Co gdy brak Zasobu ?_INSERT]
    ON [dbo].[_Slownik_Co gdy brak Zasobu ?];


GO

				CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Co gdy brak Zasobu ?_UPDATE]
				   ON [dbo].[_Slownik_Co gdy brak Zasobu ?] 
				   AFTER UPDATE
				AS 
				BEGIN
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Slownik_Co gdy brak Zasobu ?]
							...
							UPDATE [dbo].[_Slownik_Co gdy brak Zasobu ?]
