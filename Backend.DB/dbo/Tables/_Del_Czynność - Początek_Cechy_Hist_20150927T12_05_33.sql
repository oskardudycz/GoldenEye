CREATE TABLE [dbo].[_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33] (
    ...
    CONSTRAINT [PK2_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33_CalculatedByAlgorithm] FOREIGN KEY ([CalculatedByAlgorithm]) REFERENCES [dbo].[Algorytmy] ([Id]),
    CONSTRAINT [FK_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33_CechaId] FOREIGN KEY ([CechaId]) REFERENCES [dbo].[Cechy] ([Cecha_ID]),
    CONSTRAINT [FK_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33_IdArch]]] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33] ([Id]),
    CONSTRAINT [FK_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33] ([Id]),
    CONSTRAINT [FK_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33_ObiektId] FOREIGN KEY ([ObiektId]) REFERENCES [dbo].[_Del_Czynność - Początek_20150927T12:05:33] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33]
    ON [dbo].[_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33]([ObiektId] ASC, [CechaId] ASC);


GO
			
CREATE TRIGGER [dbo].[WartoscZmiany_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33_UPDATE]
   ON  [dbo].[_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33] 
   AFTER UPDATE
AS 
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN
		...
		BEGIN						
			...
			BEGIN
				...
				INSERT INTO [dbo].[_Czynność - Początek_Cechy_Hist]
				...
				UPDATE [dbo].[_Czynność - Początek_Cechy_Hist]
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33_UPDATE]
    ON [dbo].[_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33];
...
CREATE TRIGGER [dbo].[WartoscZmiany_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33_INSERT]
   ON  [dbo].[_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33] 
   AFTER INSERT
AS 
BEGIN
	...
	BEGIN
		IF EXISTS(
			...
			FROM inserted AS S1
			  JOIN [dbo].[_Czynność - Początek_Cechy_Hist] AS S2
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33_INSERT]
    ON [dbo].[_Del_Czynność - Początek_Cechy_Hist_20150927T12:05:33];
