CREATE TABLE [dbo].[_Czynności - Struktura, Początek-Operacja] (
    ...
    CONSTRAINT [PK2_Czynności - Struktura, Początek-Operacja] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Czynności - Struktura, Początek-Operacja_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Czynności - Struktura, Początek-Operacja] ([Id]),
    CONSTRAINT [FK_Czynności - Struktura, Początek-Operacja_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Czynności - Struktura, Początek-Operacja] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Czynności - Struktura, Początek-Operacja]
    ON [dbo].[_Czynności - Struktura, Początek-Operacja]([Id] ASC);


GO
CREATE TRIGGER [dbo].[WartoscZmiany_Czynności - Struktura, Początek-Operacja_UPDATE]
				   ON  [dbo].[_Czynności - Struktura, Początek-Operacja] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Czynności - Struktura, Początek-Operacja]
							...
							UPDATE [dbo].[_Czynności - Struktura, Początek-Operacja]
