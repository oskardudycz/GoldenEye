CREATE TABLE [dbo].[_Zasób - Szablon, Koniec-Operacja] (
    ...
    CONSTRAINT [PK2_Zasób - Szablon, Koniec-Operacja] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Zasób - Szablon, Koniec-Operacja_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Zasób - Szablon, Koniec-Operacja] ([Id]),
    CONSTRAINT [FK_Zasób - Szablon, Koniec-Operacja_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Zasób - Szablon, Koniec-Operacja] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Zasób - Szablon, Koniec-Operacja]
    ON [dbo].[_Zasób - Szablon, Koniec-Operacja]([Id] ASC);


GO
CREATE TRIGGER [dbo].[WartoscZmiany_Zasób - Szablon, Koniec-Operacja_UPDATE]
				   ON  [dbo].[_Zasób - Szablon, Koniec-Operacja] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Zasób - Szablon, Koniec-Operacja]
							...
							UPDATE [dbo].[_Zasób - Szablon, Koniec-Operacja]
