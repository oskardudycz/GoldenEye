CREATE TABLE [dbo].[_Del_Test 1_Cechy_Hist_20150927T12:11:12] (
    ...
    CONSTRAINT [PK2_Del_Test 1_Cechy_Hist_20150927T12:11:12] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Del_Test 1_Cechy_Hist_20150927T12:11:12_CalculatedByAlgorithm] FOREIGN KEY ([CalculatedByAlgorithm]) REFERENCES [dbo].[Algorytmy] ([Id]),
    CONSTRAINT [FK_Del_Test 1_Cechy_Hist_20150927T12:11:12_CechaId] FOREIGN KEY ([CechaId]) REFERENCES [dbo].[Cechy] ([Cecha_ID]),
    CONSTRAINT [FK_Del_Test 1_Cechy_Hist_20150927T12:11:12_IdArch]]] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Del_Test 1_Cechy_Hist_20150927T12:11:12] ([Id]),
    CONSTRAINT [FK_Del_Test 1_Cechy_Hist_20150927T12:11:12_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Del_Test 1_Cechy_Hist_20150927T12:11:12] ([Id]),
    CONSTRAINT [FK_Del_Test 1_Cechy_Hist_20150927T12:11:12_ObiektId] FOREIGN KEY ([ObiektId]) REFERENCES [dbo].[_Del_Test 1_20150927T12:11:12] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Del_Test 1_Cechy_Hist_20150927T12:11:12]
    ON [dbo].[_Del_Test 1_Cechy_Hist_20150927T12:11:12]([ObiektId] ASC, [CechaId] ASC);


GO
			
CREATE TRIGGER [dbo].[WartoscZmiany_Del_Test 1_Cechy_Hist_20150927T12:11:12_UPDATE]
   ON  [dbo].[_Del_Test 1_Cechy_Hist_20150927T12:11:12] 
   AFTER UPDATE
AS 
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN
		...
		BEGIN						
			...
			BEGIN
				...
				INSERT INTO [dbo].[_Test 1_Cechy_Hist]
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Test 1_Cechy_Hist_20150927T12:11:12_UPDATE]
    ON [dbo].[_Del_Test 1_Cechy_Hist_20150927T12:11:12];
...
CREATE TRIGGER [dbo].[WartoscZmiany_Del_Test 1_Cechy_Hist_20150927T12:11:12_INSERT]
   ON  [dbo].[_Del_Test 1_Cechy_Hist_20150927T12:11:12] 
   AFTER INSERT
AS 
BEGIN
	...
	BEGIN
		IF EXISTS(
			...
			FROM inserted AS S1
			  JOIN [dbo].[_Test 1_Cechy_Hist] AS S2
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Test 1_Cechy_Hist_20150927T12:11:12_INSERT]
    ON [dbo].[_Del_Test 1_Cechy_Hist_20150927T12:11:12];
