CREATE TABLE [dbo].[_Slownik_Tak / Nie] (
    ...
    CONSTRAINT [PK2_Slownik_Tak / Nie] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Slownik_Tak / Nie_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Slownik_Tak / Nie] ([Id]),
    CONSTRAINT [FK_Slownik_Tak / Nie_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Slownik_Tak / Nie] ([Id]),
    CONSTRAINT [FK_Slownik_Tak / Nie_TypId] FOREIGN KEY ([TypId]) REFERENCES [dbo].[Cecha_Typy] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Slownik_Tak / Nie]
    ON [dbo].[_Slownik_Tak / Nie]([Id] ASC);


GO

				CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Tak / Nie_UPDATE]
				   ON [dbo].[_Slownik_Tak / Nie] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Slownik_Tak / Nie]
				...
				END
GO
CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Tak / Nie_INSERT]
				   ON  [dbo].[_Slownik_Tak / Nie] 
				   AFTER INSERT
				AS 
				BEGIN
					...
					BEGIN
						IF EXISTS(
							...
							FROM inserted AS S1
							  JOIN [dbo].[_Slownik_Tak / Nie]  AS S2
						...
						BEGIN						
							...
							UPDATE [dbo].[_Slownik_Tak / Nie] SET 
				...
				END
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Slownik_Tak / Nie_INSERT]
    ON [dbo].[_Slownik_Tak / Nie];
