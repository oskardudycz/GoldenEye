CREATE TABLE [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38] (
    ...
    CONSTRAINT [PK2_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38] ([Id]),
    CONSTRAINT [FK_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38]
    ON [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38]([Id] ASC);


GO
			
CREATE TRIGGER [dbo].[WartoscZmiany_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38_INSERT]
   ON  [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38] 
   AFTER INSERT
AS 
BEGIN
	...
	BEGIN
		IF EXISTS(
			...
			FROM inserted AS S1
			  JOIN [dbo].[_Zupełnie nowy obiekt nietabelarycny] AS S2
		...
		BEGIN						
			...
			UPDATE [dbo].[_Zupełnie nowy obiekt nietabelarycny] 
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38_INSERT]
    ON [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38];


GO

CREATE TRIGGER [dbo].[WartoscZmiany_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38_UPDATE]
   ON  [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38] 
   AFTER UPDATE
AS 
BEGIN
	...
	BEGIN
		...
		BEGIN
			...
			INSERT INTO [dbo].[_Zupełnie nowy obiekt nietabelarycny]
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38_UPDATE]
    ON [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38];
