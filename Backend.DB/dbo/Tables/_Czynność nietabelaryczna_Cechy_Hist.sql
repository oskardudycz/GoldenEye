CREATE TABLE [dbo].[_Czynność nietabelaryczna_Cechy_Hist] (
    ...
    CONSTRAINT [PK2_Czynność nietabelaryczna_Cechy_Hist] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Czynność nietabelaryczna_Cechy_Hist_CalculatedByAlgorithm] FOREIGN KEY ([CalculatedByAlgorithm]) REFERENCES [dbo].[Algorytmy] ([Id]),
    CONSTRAINT [FK_Czynność nietabelaryczna_Cechy_Hist_CechaId] FOREIGN KEY ([CechaId]) REFERENCES [dbo].[Cechy] ([Cecha_ID]),
    CONSTRAINT [FK_Czynność nietabelaryczna_Cechy_Hist_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Czynność nietabelaryczna_Cechy_Hist] ([Id]),
    CONSTRAINT [FK_Czynność nietabelaryczna_Cechy_Hist_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Czynność nietabelaryczna_Cechy_Hist] ([Id]),
    CONSTRAINT [FK_Czynność nietabelaryczna_Cechy_Hist_ObiektId] FOREIGN KEY ([ObiektId]) REFERENCES [dbo].[_Czynność nietabelaryczna] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Czynność nietabelaryczna_Cechy_Hist]
    ON [dbo].[_Czynność nietabelaryczna_Cechy_Hist]([ObiektId] ASC, [CechaId] ASC);


GO
			
CREATE TRIGGER [dbo].[WartoscZmiany_Czynność nietabelaryczna_Cechy_Hist_UPDATE]
   ON  [dbo].[_Czynność nietabelaryczna_Cechy_Hist] 
   AFTER UPDATE
AS 
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN
		...
		BEGIN						
			...
			BEGIN
				...
				INSERT INTO [dbo].[_Czynność nietabelaryczna_Cechy_Hist]
				...
				UPDATE [dbo].[_Czynność nietabelaryczna_Cechy_Hist]
...
CREATE TRIGGER [dbo].[WartoscZmiany_Czynność nietabelaryczna_Cechy_Hist_INSERT]
   ON  [dbo].[_Czynność nietabelaryczna_Cechy_Hist] 
   AFTER INSERT
AS 
BEGIN
	...
	BEGIN
		IF EXISTS(
			...
			FROM inserted AS S1
			  JOIN [dbo].[_Czynność nietabelaryczna_Cechy_Hist] AS S2
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Czynność nietabelaryczna_Cechy_Hist_INSERT]
    ON [dbo].[_Czynność nietabelaryczna_Cechy_Hist];
