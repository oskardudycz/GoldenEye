CREATE TABLE [dbo].[_Slownik_Zleceniodawca] (
    ...
    CONSTRAINT [PK2_Slownik_Zleceniodawca] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Slownik_Zleceniodawca_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Slownik_Zleceniodawca] ([Id]),
    CONSTRAINT [FK_Slownik_Zleceniodawca_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Slownik_Zleceniodawca] ([Id]),
    CONSTRAINT [FK_Slownik_Zleceniodawca_TypId] FOREIGN KEY ([TypId]) REFERENCES [dbo].[Cecha_Typy] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Slownik_Zleceniodawca]
    ON [dbo].[_Slownik_Zleceniodawca]([Id] ASC);


GO

				CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Zleceniodawca_UPDATE]
				   ON [dbo].[_Slownik_Zleceniodawca] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Slownik_Zleceniodawca]
							...
							UPDATE [dbo].[_Slownik_Zleceniodawca]
				...
				END
GO
CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Zleceniodawca_INSERT]
				   ON  [dbo].[_Slownik_Zleceniodawca] 
				   AFTER INSERT
				AS 
				BEGIN
					...
					BEGIN
						IF EXISTS(
							...
							FROM inserted AS S1
							  JOIN [dbo].[_Slownik_Zleceniodawca]  AS S2
						...
						BEGIN						
							...
							UPDATE [dbo].[_Slownik_Zleceniodawca] SET 
				...
				END
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Slownik_Zleceniodawca_INSERT]
    ON [dbo].[_Slownik_Zleceniodawca];
