CREATE TABLE [dbo].[_Srodowisko Planowania - PLANER1] (
    ...
    CONSTRAINT [PK2_Srodowisko Planowania - PLANER1] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Srodowisko Planowania - PLANER1_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Srodowisko Planowania - PLANER1] ([Id]),
    CONSTRAINT [FK_Srodowisko Planowania - PLANER1_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Srodowisko Planowania - PLANER1] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Srodowisko Planowania - PLANER1]
    ON [dbo].[_Srodowisko Planowania - PLANER1]([Id] ASC);


GO
CREATE TRIGGER [dbo].[WartoscZmiany_Srodowisko Planowania - PLANER1_UPDATE]
				   ON  [dbo].[_Srodowisko Planowania - PLANER1] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Srodowisko Planowania - PLANER1]
							...
							UPDATE [dbo].[_Srodowisko Planowania - PLANER1]
