CREATE TABLE [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist] (
    ...
    CONSTRAINT [PK2_Zlecenie  nietabelaryczne_Cechy_Hist] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Zlecenie  nietabelaryczne_Cechy_Hist_CalculatedByAlgorithm] FOREIGN KEY ([CalculatedByAlgorithm]) REFERENCES [dbo].[Algorytmy] ([Id]),
    CONSTRAINT [FK_Zlecenie  nietabelaryczne_Cechy_Hist_CechaId] FOREIGN KEY ([CechaId]) REFERENCES [dbo].[Cechy] ([Cecha_ID]),
    CONSTRAINT [FK_Zlecenie  nietabelaryczne_Cechy_Hist_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist] ([Id]),
    CONSTRAINT [FK_Zlecenie  nietabelaryczne_Cechy_Hist_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist] ([Id]),
    CONSTRAINT [FK_Zlecenie  nietabelaryczne_Cechy_Hist_ObiektId] FOREIGN KEY ([ObiektId]) REFERENCES [dbo].[_Zlecenie  nietabelaryczne] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Zlecenie  nietabelaryczne_Cechy_Hist]
    ON [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist]([ObiektId] ASC, [CechaId] ASC);


GO
			
				
CREATE TRIGGER [dbo].[WartoscZmiany_Zlecenie  nietabelaryczne_Cechy_Hist_INSERT]
   ON  [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist] 
   AFTER INSERT
AS 
BEGIN
	...
	BEGIN
		IF EXISTS(
			...
			FROM inserted AS S1
			  JOIN [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist] AS S2
		...
		BEGIN
			...
			UPDATE [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist] 
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Zlecenie  nietabelaryczne_Cechy_Hist_INSERT]
    ON [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist];


GO
			
CREATE TRIGGER [dbo].[WartoscZmiany_Zlecenie  nietabelaryczne_Cechy_Hist_UPDATE]
   ON  [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist] 
   AFTER UPDATE
AS 
BEGIN
	...
	BEGIN
		...
		BEGIN						
			...
			BEGIN
				...
				INSERT INTO [dbo].[_Zlecenie  nietabelaryczne_Cechy_Hist]
