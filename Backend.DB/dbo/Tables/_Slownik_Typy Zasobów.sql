CREATE TABLE [dbo].[_Slownik_Typy Zasobów] (
    ...
    CONSTRAINT [PK2_Slownik_Typy Zasobów] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Slownik_Typy Zasobów_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Slownik_Typy Zasobów] ([Id]),
    CONSTRAINT [FK_Slownik_Typy Zasobów_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Slownik_Typy Zasobów] ([Id]),
    CONSTRAINT [FK_Slownik_Typy Zasobów_TypId] FOREIGN KEY ([TypId]) REFERENCES [dbo].[Cecha_Typy] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Slownik_Typy Zasobów]
    ON [dbo].[_Slownik_Typy Zasobów]([Id] ASC);


GO
CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Typy Zasobów_INSERT]
				   ON  [dbo].[_Slownik_Typy Zasobów] 
				   AFTER INSERT
				AS 
				BEGIN
					...
					BEGIN
						IF EXISTS(
							...
							FROM inserted AS S1
							  JOIN [dbo].[_Slownik_Typy Zasobów]  AS S2
						...
						BEGIN						
							...
							UPDATE [dbo].[_Slownik_Typy Zasobów] SET 
				...
				END
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Slownik_Typy Zasobów_INSERT]
    ON [dbo].[_Slownik_Typy Zasobów];


GO

				CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Typy Zasobów_UPDATE]
				   ON [dbo].[_Slownik_Typy Zasobów] 
				   AFTER UPDATE
				AS 
				BEGIN
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Slownik_Typy Zasobów]
							...
							UPDATE [dbo].[_Slownik_Typy Zasobów]
