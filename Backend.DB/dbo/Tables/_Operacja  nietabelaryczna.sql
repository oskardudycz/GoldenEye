CREATE TABLE [dbo].[_Operacja  nietabelaryczna] (
    ...
    CONSTRAINT [PK2_Operacja  nietabelaryczna] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Operacja  nietabelaryczna_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Operacja  nietabelaryczna] ([Id]),
    CONSTRAINT [FK_Operacja  nietabelaryczna_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Operacja  nietabelaryczna] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Operacja  nietabelaryczna]
    ON [dbo].[_Operacja  nietabelaryczna]([Id] ASC);


GO
CREATE TRIGGER [dbo].[WartoscZmiany_Operacja  nietabelaryczna_UPDATE]
				   ON  [dbo].[_Operacja  nietabelaryczna] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Operacja  nietabelaryczna]
							...
							UPDATE [dbo].[_Operacja  nietabelaryczna]
