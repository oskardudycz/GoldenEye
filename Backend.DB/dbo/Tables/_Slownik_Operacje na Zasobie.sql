CREATE TABLE [dbo].[_Slownik_Operacje na Zasobie] (
    ...
    CONSTRAINT [PK2_Slownik_Operacje na Zasobie] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Slownik_Operacje na Zasobie_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Slownik_Operacje na Zasobie] ([Id]),
    CONSTRAINT [FK_Slownik_Operacje na Zasobie_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Slownik_Operacje na Zasobie] ([Id]),
    CONSTRAINT [FK_Slownik_Operacje na Zasobie_TypId] FOREIGN KEY ([TypId]) REFERENCES [dbo].[Cecha_Typy] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Slownik_Operacje na Zasobie]
    ON [dbo].[_Slownik_Operacje na Zasobie]([Id] ASC);


GO

				CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Operacje na Zasobie_UPDATE]
				   ON [dbo].[_Slownik_Operacje na Zasobie] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Slownik_Operacje na Zasobie]
							...
							UPDATE [dbo].[_Slownik_Operacje na Zasobie]
				...
				END
GO
CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Operacje na Zasobie_INSERT]
				   ON  [dbo].[_Slownik_Operacje na Zasobie] 
				   AFTER INSERT
				AS 
				BEGIN
					...
					BEGIN
						IF EXISTS(
							...
							FROM inserted AS S1
							  JOIN [dbo].[_Slownik_Operacje na Zasobie]  AS S2
						...
						BEGIN						
							...
							UPDATE [dbo].[_Slownik_Operacje na Zasobie] SET 
				...
				END
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Slownik_Operacje na Zasobie_INSERT]
    ON [dbo].[_Slownik_Operacje na Zasobie];
