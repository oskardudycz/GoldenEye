CREATE TABLE [dbo].[_Zlecenie  nietabelaryczne] (
    ...
    CONSTRAINT [PK2_Zlecenie  nietabelaryczne] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Zlecenie  nietabelaryczne_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Zlecenie  nietabelaryczne] ([Id]),
    CONSTRAINT [FK_Zlecenie  nietabelaryczne_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Zlecenie  nietabelaryczne] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Zlecenie  nietabelaryczne]
    ON [dbo].[_Zlecenie  nietabelaryczne]([Id] ASC);


GO

CREATE TRIGGER [dbo].[WartoscZmiany_Zlecenie  nietabelaryczne_UPDATE]
   ON  [dbo].[_Zlecenie  nietabelaryczne] 
   AFTER UPDATE
AS 
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN
		...
		BEGIN
			...
			INSERT INTO [dbo].[_Zlecenie  nietabelaryczne]
			...
			UPDATE [dbo].[_Zlecenie  nietabelaryczne]
...
CREATE TRIGGER [dbo].[WartoscZmiany_Zlecenie  nietabelaryczne_INSERT]
   ON  [dbo].[_Zlecenie  nietabelaryczne] 
   AFTER INSERT
AS 
BEGIN
	...
	BEGIN
		IF EXISTS(
			...
			FROM inserted AS S1
			  JOIN [dbo].[_Zlecenie  nietabelaryczne] AS S2
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Zlecenie  nietabelaryczne_INSERT]
    ON [dbo].[_Zlecenie  nietabelaryczne];
