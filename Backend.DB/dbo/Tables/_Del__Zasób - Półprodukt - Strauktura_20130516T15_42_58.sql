CREATE TABLE [dbo].[_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58] (
    ...
    CONSTRAINT [PK2_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58] ([Id]),
    CONSTRAINT [FK_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58]
    ON [dbo].[_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58]([Id] ASC);


GO
CREATE TRIGGER [dbo].[WartoscZmiany_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58_UPDATE]
				   ON  [dbo].[_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[__Zasób - Półprodukt - Strauktura]
							...
							UPDATE [dbo].[__Zasób - Półprodukt - Strauktura]
				...
				END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58_UPDATE]
    ON [dbo].[_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58];
