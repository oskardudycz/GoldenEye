CREATE TABLE [dbo].[_Del_ABBBACA_20130508T14:02:49] (
    ...
    CONSTRAINT [PK2_Del_ABBBACA_20130508T14:02:49] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Del_ABBBACA_20130508T14:02:49_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Del_ABBBACA_20130508T14:02:49] ([Id]),
    CONSTRAINT [FK_Del_ABBBACA_20130508T14:02:49_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Del_ABBBACA_20130508T14:02:49] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Del_ABBBACA_20130508T14:02:49]
    ON [dbo].[_Del_ABBBACA_20130508T14:02:49]([Id] ASC);


GO
CREATE TRIGGER [dbo].[WartoscZmiany_Del_ABBBACA_20130508T14:02:49_UPDATE]
				   ON  [dbo].[_Del_ABBBACA_20130508T14:02:49] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
				...
				END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_ABBBACA_20130508T14:02:49_UPDATE]
    ON [dbo].[_Del_ABBBACA_20130508T14:02:49];
