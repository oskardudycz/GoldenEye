CREATE TABLE [dbo].[_Zasób - Szablon, Początek- Operacja] (
    ...
    CONSTRAINT [PK2_Zasób - Szablon, Początek- Operacja] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Zasób - Szablon, Początek- Operacja_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Zasób - Szablon, Początek- Operacja] ([Id]),
    CONSTRAINT [FK_Zasób - Szablon, Początek- Operacja_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Zasób - Szablon, Początek- Operacja] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Zasób - Szablon, Początek- Operacja]
    ON [dbo].[_Zasób - Szablon, Początek- Operacja]([Id] ASC);


GO
CREATE TRIGGER [dbo].[WartoscZmiany_Zasób - Szablon, Początek- Operacja_UPDATE]
				   ON  [dbo].[_Zasób - Szablon, Początek- Operacja] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Zasób - Szablon, Początek- Operacja]
							...
							UPDATE [dbo].[_Zasób - Szablon, Początek- Operacja]
