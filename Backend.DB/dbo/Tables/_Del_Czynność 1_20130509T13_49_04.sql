CREATE TABLE [dbo].[_Del_Czynność 1_20130509T13:49:04] (
    ...
    CONSTRAINT [PK2_Del_Czynność 1_20130509T13:49:04] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Del_Czynność 1_20130509T13:49:04_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Del_Czynność 1_20130509T13:49:04] ([Id]),
    CONSTRAINT [FK_Del_Czynność 1_20130509T13:49:04_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Del_Czynność 1_20130509T13:49:04] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Del_Czynność 1_20130509T13:49:04]
    ON [dbo].[_Del_Czynność 1_20130509T13:49:04]([Id] ASC);


GO
			
CREATE TRIGGER [dbo].[WartoscZmiany_Del_Czynność 1_20130509T13:49:04_INSERT]
   ON  [dbo].[_Del_Czynność 1_20130509T13:49:04] 
   AFTER INSERT
AS 
BEGIN
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Czynność 1_20130509T13:49:04_INSERT]
    ON [dbo].[_Del_Czynność 1_20130509T13:49:04];


GO

CREATE TRIGGER [dbo].[WartoscZmiany_Del_Czynność 1_20130509T13:49:04_UPDATE]
   ON  [dbo].[_Del_Czynność 1_20130509T13:49:04] 
   AFTER UPDATE
AS 
BEGIN
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Czynność 1_20130509T13:49:04_UPDATE]
    ON [dbo].[_Del_Czynność 1_20130509T13:49:04];
