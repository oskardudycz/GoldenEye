CREATE TABLE [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38] (
    ...
    CONSTRAINT [PK2_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38_CalculatedByAlgorithm] FOREIGN KEY ([CalculatedByAlgorithm]) REFERENCES [dbo].[Algorytmy] ([Id]),
    CONSTRAINT [FK_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38_CechaId] FOREIGN KEY ([CechaId]) REFERENCES [dbo].[Cechy] ([Cecha_ID]),
    CONSTRAINT [FK_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38_IdArch]]] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38] ([Id]),
    CONSTRAINT [FK_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38] ([Id]),
    CONSTRAINT [FK_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38_ObiektId] FOREIGN KEY ([ObiektId]) REFERENCES [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_20151013T07:58:38] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38]
    ON [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38]([ObiektId] ASC, [CechaId] ASC);


GO
			
CREATE TRIGGER [dbo].[WartoscZmiany_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38_UPDATE]
   ON  [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38] 
   AFTER UPDATE
AS 
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN
		...
		BEGIN						
			...
			BEGIN
				...
				INSERT INTO [dbo].[_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist]
				...
				UPDATE [dbo].[_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist]
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38_UPDATE]
    ON [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38];
...
CREATE TRIGGER [dbo].[WartoscZmiany_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38_INSERT]
   ON  [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38] 
   AFTER INSERT
AS 
BEGIN
	...
	BEGIN
		IF EXISTS(
			...
			FROM inserted AS S1
			  JOIN [dbo].[_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist] AS S2
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38_INSERT]
    ON [dbo].[_Del_Zupełnie nowy obiekt nietabelarycny_Cechy_Hist_20151013T07:58:38];
