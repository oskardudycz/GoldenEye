CREATE TABLE [dbo].[_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58] (
    ...
    CONSTRAINT [PK2_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58_CalculatedByAlgorithm] FOREIGN KEY ([CalculatedByAlgorithm]) REFERENCES [dbo].[Algorytmy] ([Id]),
    CONSTRAINT [FK_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58_CechaId] FOREIGN KEY ([CechaId]) REFERENCES [dbo].[Cechy] ([Cecha_ID]),
    CONSTRAINT [FK_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58_IdArch]]] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58] ([Id]),
    CONSTRAINT [FK_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58] ([Id]),
    CONSTRAINT [FK_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58_ObiektId] FOREIGN KEY ([ObiektId]) REFERENCES [dbo].[_Del__Zasób - Półprodukt - Strauktura_20130516T15:42:58] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58]
    ON [dbo].[_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58]([ObiektId] ASC, [CechaId] ASC);


GO

CREATE TRIGGER [dbo].[WartoscZmiany_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58_UPDATE]
   ON  [dbo].[_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58] 
   AFTER UPDATE
AS 
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN
		...
		BEGIN						
			...
			BEGIN
				...
				INSERT INTO [dbo].[__Zasób - Półprodukt - Strauktura_Cechy_Hist]
				...
				UPDATE [dbo].[__Zasób - Półprodukt - Strauktura_Cechy_Hist]
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58_UPDATE]
    ON [dbo].[_Del__Zasób - Półprodukt - Strauktura_Cechy_Hist_20130516T15:42:58];
