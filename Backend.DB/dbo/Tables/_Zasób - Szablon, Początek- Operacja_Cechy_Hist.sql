CREATE TABLE [dbo].[_Zasób - Szablon, Początek- Operacja_Cechy_Hist] (
    ...
    CONSTRAINT [PK2_Zasób - Szablon, Początek- Operacja_Cechy_Hist] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Zasób - Szablon, Początek- Operacja_Cechy_Hist_CalculatedByAlgorithm] FOREIGN KEY ([CalculatedByAlgorithm]) REFERENCES [dbo].[Algorytmy] ([Id]),
    CONSTRAINT [FK_Zasób - Szablon, Początek- Operacja_Cechy_Hist_CechaId] FOREIGN KEY ([CechaId]) REFERENCES [dbo].[Cechy] ([Cecha_ID]),
    CONSTRAINT [FK_Zasób - Szablon, Początek- Operacja_Cechy_Hist_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Zasób - Szablon, Początek- Operacja_Cechy_Hist] ([Id]),
    CONSTRAINT [FK_Zasób - Szablon, Początek- Operacja_Cechy_Hist_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Zasób - Szablon, Początek- Operacja_Cechy_Hist] ([Id]),
    CONSTRAINT [FK_Zasób - Szablon, Początek- Operacja_Cechy_Hist_ObiektId] FOREIGN KEY ([ObiektId]) REFERENCES [dbo].[_Zasób - Szablon, Początek- Operacja] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Zasób - Szablon, Początek- Operacja_Cechy_Hist]
    ON [dbo].[_Zasób - Szablon, Początek- Operacja_Cechy_Hist]([ObiektId] ASC, [CechaId] ASC);


GO

CREATE TRIGGER [dbo].[WartoscZmiany_Zasób - Szablon, Początek- Operacja_Cechy_Hist_UPDATE]
   ON  [dbo].[_Zasób - Szablon, Początek- Operacja_Cechy_Hist] 
   AFTER UPDATE
AS 
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN
		...
		BEGIN						
			...
			BEGIN
				...
				INSERT INTO [dbo].[_Zasób - Szablon, Początek- Operacja_Cechy_Hist]
				...
				UPDATE [dbo].[_Zasób - Szablon, Początek- Operacja_Cechy_Hist]
