CREATE TABLE [dbo].[_Slownik_Zlecenie - przedmiot] (
    ...
    CONSTRAINT [PK2_Slownik_Zlecenie - przedmiot] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Slownik_Zlecenie - przedmiot_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Slownik_Zlecenie - przedmiot] ([Id]),
    CONSTRAINT [FK_Slownik_Zlecenie - przedmiot_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Slownik_Zlecenie - przedmiot] ([Id]),
    CONSTRAINT [FK_Slownik_Zlecenie - przedmiot_TypId] FOREIGN KEY ([TypId]) REFERENCES [dbo].[Cecha_Typy] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Slownik_Zlecenie - przedmiot]
    ON [dbo].[_Slownik_Zlecenie - przedmiot]([Id] ASC);


GO

				CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Zlecenie - przedmiot_UPDATE]
				   ON [dbo].[_Slownik_Zlecenie - przedmiot] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Slownik_Zlecenie - przedmiot]
							...
							UPDATE [dbo].[_Slownik_Zlecenie - przedmiot]
				...
				END
GO
CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Zlecenie - przedmiot_INSERT]
				   ON  [dbo].[_Slownik_Zlecenie - przedmiot] 
				   AFTER INSERT
				AS 
				BEGIN
					...
					BEGIN
						IF EXISTS(
							...
							FROM inserted AS S1
							  JOIN [dbo].[_Slownik_Zlecenie - przedmiot]  AS S2
						...
						BEGIN						
							...
							UPDATE [dbo].[_Slownik_Zlecenie - przedmiot] SET 
				...
				END
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Slownik_Zlecenie - przedmiot_INSERT]
    ON [dbo].[_Slownik_Zlecenie - przedmiot];
