CREATE TABLE [dbo].[_Slownik_Właściciele Planu] (
    ...
    CONSTRAINT [PK2_Slownik_Właściciele Planu] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Slownik_Właściciele Planu_IdArch] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Slownik_Właściciele Planu] ([Id]),
    CONSTRAINT [FK_Slownik_Właściciele Planu_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Slownik_Właściciele Planu] ([Id]),
    CONSTRAINT [FK_Slownik_Właściciele Planu_TypId] FOREIGN KEY ([TypId]) REFERENCES [dbo].[Cecha_Typy] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Slownik_Właściciele Planu]
    ON [dbo].[_Slownik_Właściciele Planu]([Id] ASC);


GO

				CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Właściciele Planu_UPDATE]
				   ON [dbo].[_Slownik_Właściciele Planu] 
				   AFTER UPDATE
				AS 
				BEGIN
					SET NOCOUNT ON;
					...
					BEGIN
						...
						BEGIN
							...
							INSERT INTO [dbo].[_Slownik_Właściciele Planu]
							...
							UPDATE [dbo].[_Slownik_Właściciele Planu]
				...
				END
GO
CREATE TRIGGER [dbo].[WartoscZmiany_Slownik_Właściciele Planu_INSERT]
				   ON  [dbo].[_Slownik_Właściciele Planu] 
				   AFTER INSERT
				AS 
				BEGIN
					...
					BEGIN
						IF EXISTS(
							...
							FROM inserted AS S1
							  JOIN [dbo].[_Slownik_Właściciele Planu]  AS S2
						...
						BEGIN						
							...
							UPDATE [dbo].[_Slownik_Właściciele Planu] SET 
				...
				END
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Slownik_Właściciele Planu_INSERT]
    ON [dbo].[_Slownik_Właściciele Planu];
