CREATE TABLE [dbo].[_Del_ABBBACA_Cechy_Hist_20130508T14:02:49] (
    ...
    CONSTRAINT [PK2_Del_ABBBACA_Cechy_Hist_20130508T14:02:49] PRIMARY KEY NONCLUSTERED ([Id] ASC),
    CONSTRAINT [FK_Del_ABBBACA_Cechy_Hist_20130508T14:02:49_CalculatedByAlgorithm] FOREIGN KEY ([CalculatedByAlgorithm]) REFERENCES [dbo].[Algorytmy] ([Id]),
    CONSTRAINT [FK_Del_ABBBACA_Cechy_Hist_20130508T14:02:49_CechaId] FOREIGN KEY ([CechaId]) REFERENCES [dbo].[Cechy] ([Cecha_ID]),
    CONSTRAINT [FK_Del_ABBBACA_Cechy_Hist_20130508T14:02:49_IdArch]]] FOREIGN KEY ([IdArch]) REFERENCES [dbo].[_Del_ABBBACA_Cechy_Hist_20130508T14:02:49] ([Id]),
    CONSTRAINT [FK_Del_ABBBACA_Cechy_Hist_20130508T14:02:49_IdArchLink] FOREIGN KEY ([IdArchLink]) REFERENCES [dbo].[_Del_ABBBACA_Cechy_Hist_20130508T14:02:49] ([Id]),
    CONSTRAINT [FK_Del_ABBBACA_Cechy_Hist_20130508T14:02:49_ObiektId] FOREIGN KEY ([ObiektId]) REFERENCES [dbo].[_Del_ABBBACA_20130508T14:02:49] ([Id])
);


GO
CREATE CLUSTERED INDEX [PK_Del_ABBBACA_Cechy_Hist_20130508T14:02:49]
    ON [dbo].[_Del_ABBBACA_Cechy_Hist_20130508T14:02:49]([ObiektId] ASC, [CechaId] ASC);


GO

CREATE TRIGGER [dbo].[WartoscZmiany_Del_ABBBACA_Cechy_Hist_20130508T14:02:49_UPDATE]
   ON  [dbo].[_Del_ABBBACA_Cechy_Hist_20130508T14:02:49] 
   AFTER UPDATE
AS 
BEGIN
	SET NOCOUNT ON;
	...
	BEGIN
		...
		BEGIN						
			...
			BEGIN
				...
				INSERT INTO [dbo].[_ABBBACA_Cechy_Hist]
				...
				UPDATE [dbo].[_ABBBACA_Cechy_Hist]
...
END	
GO
DISABLE TRIGGER [dbo].[WartoscZmiany_Del_ABBBACA_Cechy_Hist_20130508T14:02:49_UPDATE]
    ON [dbo].[_Del_ABBBACA_Cechy_Hist_20130508T14:02:49];
