CREATE XML SCHEMA COLLECTION [dbo].[Schema_Units_SaveAlternativeHistoryAttribute]
      ...
      <xsd:complexContent>
        <xsd:extension base="Request_BaseType">
          <xsd:sequence>
            ...
            <xsd:element name="AttributesToReplace" type="AttributesToReplace" minOccurs="0" />
          </xsd:sequence>
          <xsd:attribute name="UnitId" type="xsd:unsignedInt" use="required" />
          <xsd:attribute name="UnitTypeId" type="xsd:unsignedInt" use="required" />
          <xsd:attribute name="HistoryType" type="HistoryTypeRange" use="required" />
        </xsd:extension>
      </xsd:complexContent>
    </xsd:complexType>
  </xsd:element>
  ...
  <xsd:complexType name="Attribute">
    <xsd:complexContent>
      <xsd:extension base="SimpleAttribute">
        <xsd:sequence>
  ...
  <xsd:complexType name="AttributesToReplace">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence>
          <xsd:element name="Attribute" type="SimpleAttribute" minOccurs="0" maxOccurs="unbounded" />
        </xsd:sequence>
      </xsd:restriction>
    </xsd:complexContent>
  </xsd:complexType>
  ...
  <xsd:simpleType name="HistoryTypeRange">
