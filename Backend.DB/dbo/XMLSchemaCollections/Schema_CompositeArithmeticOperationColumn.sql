CREATE XML SCHEMA COLLECTION [dbo].[Schema_CompositeArithmeticOperationColumn]
    AS N'<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
  <xsd:element name="OperatationData" type="OperatationData" />
  ...
  <xsd:complexType name="OperatationData">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence>
  ...
  <xsd:complexType name="Relation">
    <xsd:complexContent>
      <xsd:extension base="TargetRelation">
        <xsd:sequence />
