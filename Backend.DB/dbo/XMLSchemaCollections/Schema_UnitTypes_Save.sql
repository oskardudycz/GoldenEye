CREATE XML SCHEMA COLLECTION [dbo].[Schema_UnitTypes_Save]
    AS N'<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
  <xsd:element name="Request" type="Request_UnitTypes_Save" />
  ...
  <xsd:complexType name="Request_UnitTypes_Save">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence maxOccurs="unbounded">
          <xsd:element name="UnitType" type="UnitType" maxOccurs="unbounded" />
        </xsd:sequence>
  ...
  <xsd:complexType name="UnitType">
    <xsd:complexContent>
      <xsd:extension base="Entity_Type">
        ...
        <xsd:attribute name="IsTable" type="xsd:boolean" use="required" />
      </xsd:extension>
    </xsd:complexContent>
  </xsd:complexType>
