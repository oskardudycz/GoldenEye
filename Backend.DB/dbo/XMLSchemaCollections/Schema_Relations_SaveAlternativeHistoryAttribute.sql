CREATE XML SCHEMA COLLECTION [dbo].[Schema_Relations_SaveAlternativeHistoryAttribute]
  ...
  <xsd:simpleType name="ProcedureEnum">
    <xsd:restriction base="xsd:string">
      ...
      <xsd:enumeration value="Relations_SaveAlternativeHistoryAttribute" />
      <xsd:enumeration value="Relations_SetMainHistFlow" />
    </xsd:restriction>
  </xsd:simpleType>
