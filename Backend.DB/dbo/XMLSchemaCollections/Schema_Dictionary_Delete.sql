CREATE XML SCHEMA COLLECTION [dbo].[Schema_Dictionary_Delete]
    ...
    <xsd:complexType>
      <xsd:complexContent>
        <xsd:restriction base="xsd:anyType">
          <xsd:sequence>
            <xsd:element name="Dictionary" type="Dictionary" maxOccurs="unbounded" />
          </xsd:sequence>
  ...
  <xsd:simpleType name="datetimeSQL">
    <xsd:restriction base="xsd:string">
      <xsd:pattern value="((000[1-9])|(00[1-9][0-9])|(0[1-9][0-9]{2})|([1-9][0-9]{3}))-((0[1-9])|(1[012]))-((0[1-9])|([12][0-9])|(3[01]))T(([01][0-9])|(2[0-3]))(:[0-5][0-9]){2}(\.[0-9]{3})?(Z?)" />
    </xsd:restriction>
  </xsd:simpleType>
</xsd:schema>';
