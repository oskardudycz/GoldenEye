CREATE XML SCHEMA COLLECTION [dbo].[Schema_Branches_Delete]
  ...
  <xsd:complexType name="Request_Delete_BaseType">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence>
          <xsd:element name="SimpleRef" type="SimpleRef" maxOccurs="unbounded" />
        </xsd:sequence>
  ...
  <xsd:complexType name="SimpleRef">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence />
  ...
  <xsd:simpleType name="EntityType">
    <xsd:restriction base="xsd:string">
      ...
      <xsd:enumeration value="AttributeDataType" />
