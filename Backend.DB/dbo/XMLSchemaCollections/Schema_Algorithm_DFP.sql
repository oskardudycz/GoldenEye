CREATE XML SCHEMA COLLECTION [dbo].[Schema_Algorithm_DFP]
    ...
    <xsd:complexType>
      <xsd:complexContent>
        <xsd:extension base="Request_BaseType">
          <xsd:sequence>
            <xsd:element name="FirstObject" type="FirstObject" />
            <xsd:element name="LastObject" type="LastObject" />
          </xsd:sequence>
          <xsd:attribute name="Date" type="dateSQL" use="required" />
  ...
  <xsd:complexType name="FirstObject">
    <xsd:complexContent>
  ...
  <xsd:complexType name="LastObject">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence />
        <xsd:attributeGroup ref="Identifications_AG" />
  ...
  <xsd:simpleType name="ProcedureEnum">
    <xsd:restriction base="xsd:string">
      ...
      <xsd:enumeration value="Algorithm_DFP" />
    </xsd:restriction>
  </xsd:simpleType>
