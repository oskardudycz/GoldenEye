CREATE XML SCHEMA COLLECTION [dbo].[Schema_AttributeTypes_Save]
    AS N'<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
  <xsd:element name="Request" type="Request_AttributeTypes_Save" />
    ...
    <xsd:complexContent>
      <xsd:extension base="Entity_Type">
        <xsd:sequence>
          ...
          <xsd:element name="LinkedBranches" minOccurs="0">
            <xsd:complexType>
              <xsd:complexContent>
        ...
        <xsd:attribute name="TimeIntervalId" type="xsd:unsignedInt" />
        <xsd:attribute name="TemporaryValue" type="xsd:boolean" use="required" />
        <xsd:attribute name="IsTraced" type="xsd:boolean" use="required" />
        ...
        <xsd:attribute name="RelationTypeId" type="xsd:int" />
        <xsd:attribute name="UnitTypeId" type="xsd:int" />
      </xsd:extension>
    </xsd:complexContent>
  </xsd:complexType>
  ...
  <xsd:complexType name="Request_AttributeTypes_Save">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence maxOccurs="unbounded">
          <xsd:element name="AttributeType" type="AttributeType" maxOccurs="unbounded" />
        </xsd:sequence>
          ...
          <xsd:element name="Conversions" minOccurs="0">
            <xsd:complexType>
              <xsd:complexContent>
                <xsd:restriction base="xsd:anyType">
                  <xsd:sequence>
                    <xsd:element name="UnitsOfMeasureConversion" minOccurs="0" maxOccurs="unbounded">
                      <xsd:complexType>
                        <xsd:complexContent>
                          <xsd:restriction base="xsd:anyType">
                            <xsd:all>
                              <xsd:element name="Ref" type="Ref" />
                              <xsd:element name="Conversion" type="xsd:double" />
                            </xsd:all>
                          </xsd:restriction>
                        </xsd:complexContent>
                      </xsd:complexType>
