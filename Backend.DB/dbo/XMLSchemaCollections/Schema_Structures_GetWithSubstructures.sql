CREATE XML SCHEMA COLLECTION [dbo].[Schema_Structures_GetWithSubstructures]
    ...
    <xsd:complexType>
      <xsd:complexContent>
        <xsd:restriction base="xsd:anyType">
          ...
          <xsd:attribute name="MaxLevel" type="xsd:unsignedInt" use="required" />
        </xsd:restriction>
      </xsd:complexContent>
    </xsd:complexType>
  </xsd:element>
  ...
  <xsd:simpleType name="ProcedureEnum_Type">
    <xsd:restriction base="xsd:string">
      ...
      <xsd:enumeration value="Users_GetForHistory" />
      <xsd:enumeration value="Structures_GetWithSubstructures" />
    </xsd:restriction>
  </xsd:simpleType>
