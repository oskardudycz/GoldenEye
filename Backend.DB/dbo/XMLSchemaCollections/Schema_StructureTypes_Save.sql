CREATE XML SCHEMA COLLECTION [dbo].[Schema_StructureTypes_Save]
    AS N'<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
  <xsd:element name="Request" type="Request_StructureTypes_Save" />
  ...
  <xsd:complexType name="Request_StructureTypes_Save">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence maxOccurs="unbounded">
          <xsd:element name="StructureType" type="StructureType" maxOccurs="unbounded" />
        </xsd:sequence>
  ...
  <xsd:complexType name="StructureType">
    <xsd:complexContent>
      <xsd:extension base="Entity_Type">
        ...
        <xsd:attribute name="StructureKind" type="xsd:unsignedInt" />
      </xsd:extension>
    </xsd:complexContent>
  </xsd:complexType>
