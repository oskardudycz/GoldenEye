CREATE XML SCHEMA COLLECTION [dbo].[Schema_StandardRequest]
    ...
    <xsd:complexType>
      <xsd:complexContent>
        <xsd:restriction base="xsd:anyType">
          <xsd:sequence>
            <xsd:element name="CompositeFilterDescriptor" type="CompositeFilter_Type" minOccurs="0" />
  ...
  <xsd:attributeGroup name="BaseRequest_AG">
    ...
    <xsd:attribute name="StructureTypeId" type="xsd:unsignedInt" />
  ...
  <xsd:complexType name="CompositeFilter_Type">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence>
          <xsd:choice>
            <xsd:sequence>
              <xsd:element name="CompositeFilterDescriptor" type="CompositeFilter_Type" maxOccurs="unbounded" />
            </xsd:sequence>
            <xsd:sequence>
              <xsd:element name="FilterDescriptor" type="FilterDescriptor" maxOccurs="unbounded" />
              <xsd:element name="CompositeFilterDescriptor" type="CompositeFilter_Type" minOccurs="0" maxOccurs="unbounded" />
            </xsd:sequence>
          </xsd:choice>
        </xsd:sequence>
        <xsd:attribute name="LogicalOperator" use="required">
          <xsd:simpleType>
  ...
  <xsd:complexType name="FilterDescriptor">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence />
