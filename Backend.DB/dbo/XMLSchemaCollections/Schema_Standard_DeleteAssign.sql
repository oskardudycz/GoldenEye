CREATE XML SCHEMA COLLECTION [dbo].[Schema_Standard_DeleteAssign]
    ...
    <xsd:complexType>
      <xsd:complexContent>
        <xsd:extension base="Request_BaseType">
          <xsd:sequence>
            <xsd:element name="Ref" type="Ref_Children" />
          </xsd:sequence>
  ...
  <xsd:complexType name="Ref_Children">
    <xsd:complexContent>
  ...
  <xsd:simpleType name="EntityTypeEnum">
    <xsd:restriction base="xsd:string">
      ...
      <xsd:enumeration value="UnitOfMeasureConversion" />
  ...
  <xsd:simpleType name="ProcedureEnum">
    <xsd:restriction base="xsd:string">
      ...
      <xsd:enumeration value="Structures_DeleteAssignedRelations" />
    </xsd:restriction>
  </xsd:simpleType>
