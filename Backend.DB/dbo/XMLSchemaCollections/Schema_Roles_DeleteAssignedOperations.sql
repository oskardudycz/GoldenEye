CREATE XML SCHEMA COLLECTION [dbo].[Schema_Roles_DeleteAssignedOperations]
    ...
    <xsd:complexType>
      <xsd:complexContent>
        <xsd:extension base="Request_BaseType">
          <xsd:sequence>
            <xsd:element name="CouplerRoleOperation" type="CouplerRoleOperation" maxOccurs="unbounded" />
          </xsd:sequence>
