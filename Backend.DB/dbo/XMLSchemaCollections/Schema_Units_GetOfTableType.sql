CREATE XML SCHEMA COLLECTION [dbo].[Schema_Units_GetOfTableType]
    ...
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence>
          <xsd:choice>
            <xsd:sequence>
              <xsd:element name="CompositeFilterDescriptor" type="CompositeAttributesFilter_Type" maxOccurs="unbounded" />
            </xsd:sequence>
            <xsd:sequence>
  ...
  <xsd:simpleType name="ProcedureEnum_Type">
    <xsd:restriction base="xsd:string">
      ...
      <xsd:enumeration value="Units_GetOfTableType" />
