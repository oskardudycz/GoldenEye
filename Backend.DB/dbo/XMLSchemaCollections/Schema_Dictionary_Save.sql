CREATE XML SCHEMA COLLECTION [dbo].[Schema_Dictionary_Save]
    AS N'<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
  <xsd:element name="Request" type="Request_Dictionary_Save" />
  ...
  <xsd:complexType name="Dictionary">
    <xsd:complexContent>
      <xsd:extension base="Entity_Type">
        ...
        <xsd:attribute name="DataTypeId" type="xsd:unsignedInt" use="required" />
      </xsd:extension>
    </xsd:complexContent>
  </xsd:complexType>
  ...
  <xsd:complexType name="Request_Dictionary_Save">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
        <xsd:all>
