CREATE XML SCHEMA COLLECTION [dbo].[Schema_Attribute_GetHistory]
    ...
    <xsd:complexType>
      <xsd:complexContent>
        <xsd:restriction base="xsd:anyType">
          <xsd:choice>
            <xsd:sequence>
              <xsd:element name="ObjectRef" type="ObjectRef" maxOccurs="unbounded" />
            </xsd:sequence>
            <xsd:sequence>
              <xsd:element name="AttributeRef" type="AttributeRef" maxOccurs="unbounded" />
            </xsd:sequence>
          </xsd:choice>
  ...
  <xsd:complexType name="AttributeRef">
    <xsd:complexContent>
      <xsd:extension base="ObjectRef">
        <xsd:sequence />
        <xsd:attribute name="AttributeId" type="xsd:positiveInteger" use="required" />
      </xsd:extension>
    </xsd:complexContent>
  </xsd:complexType>
