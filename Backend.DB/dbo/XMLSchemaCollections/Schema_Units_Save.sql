CREATE XML SCHEMA COLLECTION [dbo].[Schema_Units_Save]
    AS N'<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
  <xsd:element name="Request" type="Request_Units_Save" />
      ...
      <xsd:restriction base="xsd:anyType">
        <xsd:sequence>
          ...
          <xsd:choice>
            ...
            <xsd:sequence>
              <xsd:element name="ValString" minOccurs="0">
                <xsd:complexType>
                  <xsd:complexContent>
                    <xsd:restriction base="xsd:anyType">
                      <xsd:sequence>
            ...
            <xsd:sequence>
              <xsd:element name="ValDecimal" minOccurs="0">
                <xsd:complexType>
                  <xsd:complexContent>
                    <xsd:restriction base="xsd:anyType">
                      <xsd:sequence>
  ...
  <xsd:complexType name="Request_Units_Save">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
