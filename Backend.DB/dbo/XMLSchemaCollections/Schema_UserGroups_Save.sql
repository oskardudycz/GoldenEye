CREATE XML SCHEMA COLLECTION [dbo].[Schema_UserGroups_Save]
    AS N'<xsd:schema xmlns:xsd="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified">
  <xsd:element name="Request" type="Request_UserGroups_Save" />
  ...
  <xsd:complexType name="Request_UserGroups_Save">
    <xsd:complexContent>
      <xsd:restriction base="xsd:anyType">
  ...
  <xsd:simpleType name="ProcedureEnum_Type">
    <xsd:restriction base="xsd:string">
      ...
      <xsd:enumeration value="UnitsTypes_Branches_Get" />
