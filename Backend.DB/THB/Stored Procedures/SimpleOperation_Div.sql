...
-- Last modified on: --
-- Description:	Wylicza iloraz dla 2 podanych argumentów

-- XML wejsciowy w postaci:

	--<Request UserId="1" AppDate="2012-01-01T11:34:33" >
	--	<Scalar Lp="1" Value="30"/>
	--	<Unit Lp="2" Id="2" TypeId="81" AttributeTypeId="19"/>
	--</Request>
...
-- =============================================
CREATE PROCEDURE [THB].[SimpleOperation_Div]
(
...
BEGIN
	...
	DECLARE @inputXml nvarchar(MAX) = '',
		...
		@MaUprawnienia bit,
		@BranchId int,
		@RequestType nvarchar(50) = 'SimpleOperation_Mul',
		@UserId int,
		@ERRMSG nvarchar(MAX),
		@xml_data xml,
		@xmlOk bit
