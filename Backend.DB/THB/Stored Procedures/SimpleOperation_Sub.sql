...
-- Last modified on: --
-- Description:	Wylicza różnicę dla 2 podanych argumentów
...
--<Response ResponseType="SimpleOperation_Sub" AppDate="2012-01-01">
--	<Result>
--		<Value>4</Value>
--	</Result>
--</Response>
...
-- =============================================
CREATE PROCEDURE [THB].[SimpleOperation_Sub]
(
...
BEGIN
	...
	DECLARE @inputXml nvarchar(MAX) = '',
		...
		@MaUprawnienia bit,
		@BranchId int,
		@RequestType nvarchar(50) = 'SimpleOperation_Sub',
		@UserId int,
		@ERRMSG nvarchar(MAX),
		@xml_data xml,
		@xmlOk bit
