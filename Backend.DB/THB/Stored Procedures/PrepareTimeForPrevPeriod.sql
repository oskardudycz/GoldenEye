...
-- Description:	Zwraca minimalny i maksymalny czas dla poprzedniego przedziału czasowego na podstawie podanej daty.
-- =============================================
CREATE PROCEDURE [THB].[PrepareTimeForPrevPeriod]
(
	@AppDate datetime,
	@TimeIntervalId int,
